...
If you encounter errors running the complete setup, follow these steps one by one:
...
**Check**: All triggers created successfully ✅
...
**Check**: All RLS policies created successfully ✅

---

## Step 6: Enable Realtime & Create Indexes
...
**Check**: Realtime enabled and indexes created successfully ✅
...
**Solution**: The table already exists. Skip that step or drop the table first.

### Error: "permission denied"
**Solution**: Make sure you're running as the postgres user or have sufficient privileges.

### Error: "function already exists"
**Solution**: Use `CREATE OR REPLACE FUNCTION` (already in scripts above).

### Error: "trigger already exists"
**Solution**: Drop trigger first (already in scripts above).
